            ...
            <div className="container mx-auto px-4 sm:px-6">
                ...
                <div className="flex flex-col md:flex-row justify-around items-start md:items-center space-y-8 md:space-y-0 md:space-x-8">
                    ...
                    <div className="flex flex-col items-center md:items-end md:w-1/3">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Email: <a href="mailto:babariyahirak@gmail.com" className="hover:text-[#2596be] dark:hover:text-[#74c1d7]">support@bullstocks.com</a></p>
                        ...
                        <a href="https://github.com/HirakBabariya/bullstocks" target="_blank" rel="noopener noreferrer" className="mt-4 flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-[#2596be] dark:hover:text-[#74c1d7] transition-colors">
                            <FaGithub size={20} />
                ...
                <div className="flex justify-center space-x-8 mb-8">
                    ...
                    <a href="https://www.linkedin.com/in/hirakbabariya/" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-[#2596be] dark:hover:text-[#74c1d7] transition-transform transform hover:scale-110">
                        <FaLinkedin size={28} />
                    </a>
